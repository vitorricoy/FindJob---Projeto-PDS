...
export function Register () {
    ...
    const handleRegisterClick = (event: any) => {
        ...
        if (checked) {
            ...
            axios.post('/user/register/freelancer', new CreateFreelancerInput(info.email, info.password, info.name, info.phone, info.skills, info.ratings))
            .catch(function (error) {
                console.log(error);
            });
            ...
            axios.post('/user/register/freelancer', new CreateClientInput(info.email, info.password, info.name, info.phone))
            .catch(function (error) {
                console.log(error);
            });
        }
